...
int main(int argc, char *argv[]) {
    ...
    clock_t time_point, time_perpendicular_bisector, time_vertex, time_total, start;
    output_init();
    for (int i=1;i<=multiplication_times;i++) {
        ...
        time_total = time_point + time_perpendicular_bisector + time_vertex;
        output_insert(i*multiplication_value, ((double)time_point)/CLOCKS_PER_SEC, ((double)time_perpendicular_bisector)/CLOCKS_PER_SEC, ((double)time_vertex)/CLOCKS_PER_SEC, ((double)time_total)/CLOCKS_PER_SEC);
    }   
    // cout << "hello\n";
    // cout << rank << endl;
    MPI_Finalize();
